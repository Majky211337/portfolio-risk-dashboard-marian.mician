# Frozen copy of portfolio_engine.py from commit 187badc (the Dash v1 release).
# Used only by tests/test_regression.py as the reference implementation.
# Do not edit: the code below this header is byte-for-byte the legacy engine.
